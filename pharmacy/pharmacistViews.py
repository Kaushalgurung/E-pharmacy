...
def userProfile(request):
    ...
    if request.method == "POST":
        ...
        customuser.save()
        doctor = Pharmacist.objects.get(admin=customuser.id)
        form=CustomerForm(request.POST,request.FILES,instance=doctor)
    ...
    return render(request,'pharmacist_templates/doctor_profile.html',context)
