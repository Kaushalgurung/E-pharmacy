...
urlpatterns=[
    ...
    path('admin_user/edit_pharmacist/<doctor_id>/', HODViews.editPharmacist, name="edit_pharmacist"),
...
#    path('manage_dispe/<str:pk>/',pharmacistViews.dispenseDrug,name='pharm_disp'),
    ...
    path('doctor_profile/',pharmacistViews.userProfile,name='pharmacist_profile'),
    ...
    path('doctor_feedback_save/', patient_view.patient_feedback_save, name="patient_feedback_save"),
